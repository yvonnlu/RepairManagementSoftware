            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-indigo-100">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-2">
                        <div
                            class="w-12 h-12 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full flex items-center justify-center">
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            @foreach ($orderList as $order)
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        <div
                                            class="w-8 h-8 bg-gradient-to-r from-indigo-400 to-purple-500 rounded-full flex items-center justify-center text-white font-bold text-sm">
                                            {{ $order['stt'] }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            ...
                                            <span
                                                class="text-sm font-medium text-gray-900">{{ $order['updated_at']->format('M d, Y') }}</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            ...
                                            <span
                                                class="text-sm font-medium text-gray-900">{{ $order['device_type_name'] }}</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div
                                                class="w-10 h-10 bg-gradient-to-r from-orange-400 to-red-500 rounded-lg flex items-center justify-center mr-3">
                                                <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            ...
                                            <span
                                                class="text-sm font-medium text-gray-900">{{ $order['issue_category_name'] }}</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        @php
                                            ...
                                            $badgeClass =
                                                'px-3 py-2 inline-flex text-xs leading-5 font-bold rounded-lg shadow-sm ';
                                    ...
                                    <td class="px-6 py-4">
                                        @php
                                            ...
                                            if ($paymentMethod === 'vnpay') {
                                                $methodBadgeClass .= 'bg-blue-100 text-blue-800 border border-blue-200';
                                                $methodIcon = '💳';
                                                $methodText = 'VNPay';
                                                ...
                                                $methodBadgeClass .= 'bg-gray-100 text-gray-800 border border-gray-200';
                                                $methodIcon = '❓';
                                                $methodText = 'Not Set';
                                            }
                                        @endphp
