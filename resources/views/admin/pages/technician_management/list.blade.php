...
<div class="space-y-6" x-data="technicianManagement()">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse($technicians as $technician)
            @php
                $workloadPercentage = $technician->max_workload > 0 ? 
                    round(($technician->current_workload / $technician->max_workload) * 100) : 0;
            @endphp
            <div class="bg-white rounded-lg shadow-sm border hover:shadow-md transition-shadow">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div class="text-center p-2 bg-gray-50 rounded">
                            <p class="text-lg font-bold text-gray-900">{{ round($technician->avg_repair_time / 60) }}h</p>
                    ...
                    <div class="mb-4">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <span class="text-sm text-gray-600">{{ $technician->current_workload }}/{{ $technician->max_workload }}</span>
                        </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-4">
                            <div class="bg-gray-50 p-4 rounded-lg">
                                ...
                                <div class="space-y-2">
                                    <div><strong>Name:</strong> <span x-text="selectedTechnician.name"></span></div>
                                    <div><strong>Employee ID:</strong> <span x-text="selectedTechnician.employee_id"></span></div>
                                    <div><strong>Role:</strong> <span x-text="selectedTechnician.role_label"></span></div>
                                    <div><strong>Email:</strong> <span x-text="selectedTechnician.email"></span></div>
                                    <div><strong>Phone:</strong> <span x-text="selectedTechnician.phone"></span></div>
                                    <div><strong>Hire Date:</strong> <span x-text="selectedTechnician.hire_date"></span></div>
                                </div>
                            </div>
                            <div class="bg-gray-50 p-4 rounded-lg">
                                ...
                                <div class="space-y-3">
                                    <div>
                                        ...
                                        <div class="flex flex-wrap gap-1 mt-1">
                                            <template x-for="specialty in selectedTechnician.specialties_array" :key="specialty">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex flex-wrap gap-1 mt-1">
                                            <template x-for="cert in selectedTechnician.certifications_array" :key="cert">
                                                <span class="px-2 py-1 bg-green-100 text-green-800 text-xs rounded-full" x-text="cert"></span>
                                            </template>
                                        </div>
                                    </div>
                                    <div><strong>Skill Level:</strong> <span x-text="selectedTechnician.skill_level"></span>/10</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div class="bg-gray-50 p-4 rounded-lg">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="text-center p-3 bg-white rounded">
                                        <p class="text-2xl font-bold text-blue-600" x-text="selectedTechnician.rating"></p>
                                        <p class="text-sm text-gray-500">Rating</p>
                                    </div>
                                    <div class="text-center p-3 bg-white rounded">
                                        <p class="text-2xl font-bold text-green-600" x-text="selectedTechnician.total_repairs"></p>
                                        <p class="text-sm text-gray-500">Total Repairs</p>
                                    </div>
                                    <div class="text-center p-3 bg-white rounded">
                                        <p class="text-2xl font-bold text-purple-600" x-text="selectedTechnician.success_rate + '%'"></p>
                                        <p class="text-sm text-gray-500">Success Rate</p>
                                    </div>
                                    <div class="text-center p-3 bg-white rounded">
                                        <p class="text-2xl font-bold text-orange-600" x-text="Math.round(selectedTechnician.avg_repair_time / 60) + 'h'"></p>
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex justify-between">
                                        <span>Workload:</span>
                                        <span x-text="selectedTechnician.current_workload + '/' + selectedTechnician.max_workload"></span>
                                    </div>
                                    <div class="flex justify-between">
...
function technicianManagement() {
    return {
        ...
        deleteTechnician(technicianId, technicianName) {
            this.technicianToDelete = { id: technicianId, name: technicianName };
