                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <a href="{{ route('admin.service.create') }}"
                            ...
                            <p class="text-sm font-medium text-gray-600 group-hover:text-purple-600">Services</p>
                        </a>
                        <a href="{{ route('admin.inventory.create') }}"
                            ...
                            <p class="text-sm font-medium text-gray-600 group-hover:text-orange-600">Parts</p>
                        </a>
                    </div>
                </div>
            </div>
