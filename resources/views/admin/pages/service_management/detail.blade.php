                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative">
                            ...
                            <div class="text-sm text-slate-500 mt-1">
                                URL-friendly version for SEO:
                                <strong>/service/{{ $service->slug ?: 'your-slug-here' }}</strong>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        document.getElementById('generate-slug-btn').addEventListener('click', function() {
            ...
            if (deviceType && issueCategory) {
                ...
                // Update preview URL
                const previewElement = document.querySelector('.text-sm.text-slate-500 strong');
                if (previewElement) {
                    previewElement.textContent = '/service/' + slug;
                }
            } else {
        ...
        document.querySelector('input[name="slug"]').addEventListener('input', function() {
            ...
            const previewElement = document.querySelector('.text-sm.text-slate-500 strong');
            if (previewElement) {
                previewElement.textContent = '/service/' + (slug || 'your-slug-here');
            }
        });
    </script>
