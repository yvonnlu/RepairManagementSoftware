...
<div class="p-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="device_type" value="{{ old('device_type', $quoteRequest->device_type) }}" 
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="issue" rows="3" 
                                      placeholder="No issue description provided"
                        ...
                        <div>
                            ...
                            <select name="is_existing_customer" 
                                ...
                                <option value="0" {{ old('is_existing_customer', $quoteRequest->is_existing_customer) == 0 ? 'selected' : '' }}>New Customer</option>
                                <option value="1" {{ old('is_existing_customer', $quoteRequest->is_existing_customer) == 1 ? 'selected' : '' }}>Existing Customer</option>
                            </select>
            ...
            <div class="space-y-6">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <select name="status" 
                                ...
                                <option value="pending" {{ old('status', $quoteRequest->status) === 'pending' ? 'selected' : '' }}>Pending</option>
                ...
                {{-- <div class="bg-white rounded-lg shadow-sm border p-6">
                    ...
                    <div class="space-y-2">
                        ...
                        @endif
                        <button type="button" onclick="if(confirm('Are you sure you want to delete this quote request?')) { document.getElementById('delete-form').submit(); }"
    ...
    <!-- Hidden Delete Form -->
    <form id="delete-form" action="{{ route('admin.quote-requests.destroy', $quoteRequest) }}" method="POST" class="hidden">
        @csrf
        @method('DELETE')
    </form>
</div>
