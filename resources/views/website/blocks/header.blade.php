    ...
    <nav class="bg-white border-b border-gray-100">
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <button onclick="scrollToSection('home')" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">
                        Home
                    </button>
                    <button onclick="scrollToSection('services')" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">
                        Services
                    </button>
                    <button onclick="scrollToSection('features')" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">
                        Features
                    </button>
                    <button onclick="scrollToSection('testimonials')" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">
                        Reviews
                    </button>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white border-t border-gray-100">
            <div class="container mx-auto px-4 py-4 space-y-4">
                <button onclick="scrollToSection('home')" class="block w-full text-left text-gray-700 hover:text-blue-600 font-medium py-2 transition-colors">
                    Home
                </button>
                <button onclick="scrollToSection('services')" class="block w-full text-left text-gray-700 hover:text-blue-600 font-medium py-2 transition-colors">
                    Services
                </button>
                <button onclick="scrollToSection('features')" class="block w-full text-left text-gray-700 hover:text-blue-600 font-medium py-2 transition-colors">
                    Features
                </button>
                <button onclick="scrollToSection('testimonials')" class="block w-full text-left text-gray-700 hover:text-blue-600 font-medium py-2 transition-colors">
                    Reviews
                </button>
