...
<div class="container mx-auto px-4 py-12 mt-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="md:col-span-1 bg-white rounded-xl shadow-lg p-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" value="{{ $user->name }}" class="w-full border rounded-lg px-3 py-2" required>
                </div>
                <div class="mb-4">
                    <label class="block font-semibold mb-1">Address</label>
                    <input type="text" name="address" value="{{$user->address}}" class="w-full border rounded-lg px-3 py-2" required>
                </div>
                <div class="mb-4">
                    <label class="block font-semibold mb-1">Phone Number</label>
                    <input type="text" name="phone_number" value="{{$user->phone_number}}" class="w-full border rounded-lg px-3 py-2" required>
                </div>
                <div class="mb-4">
                    <label class="block font-semibold mb-1">Email</label>
                    <input type="email" name="email" value="{{$user->email}}" class="w-full border rounded-lg px-3 py-2" required>
                </div>
                <div class="mb-4">
                    <label class="block font-semibold mb-1">Note</label>
                    <textarea name="note" class="w-full border rounded-lg px-3 py-2" rows="3" placeholder="Notes about your order, e.g. special notes for delivery."></textarea>
                </div>
            </div>
    ...
    @endforeach
            ...
            <div class="md:col-span-1 bg-white rounded-xl shadow-lg p-6 flex flex-col justify-between">
                ...
                <button type="submit" class="w-full bg-blue-600 text-white py-3 rounded-lg font-bold text-lg mt-6 hover:bg-blue-700 transition">Place Order</button>
            </div>
        </div>
