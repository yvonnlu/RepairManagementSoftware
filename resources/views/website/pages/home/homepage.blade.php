                ...
                <div class="container mx-auto px-6">
                    <div class="text-center mb-16">
                        ...
                        <p class="text-xl text-gray-600 max-w-4xl mx-auto">
                            We specialize in comprehensive electronics repair services using cutting-edge diagnostic
                            technology,
                            genuine replacement parts, and expert craftsmanship. From everyday devices to specialized
                            equipment,
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                        ...
                        <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 group">
                            <div class="flex items-start space-x-6">
                                <div
                                    class="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 group">
                            <div class="flex items-start space-x-6">
                                <div
                                    class="w-16 h-16 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 group">
                            <div class="flex items-start space-x-6">
                                <div
                                    class="w-16 h-16 bg-gradient-to-br from-pink-500 to-pink-600 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                ...
                <div class="container mx-auto px-6">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-8">
                            ...
                            @if (session('success'))
                                <div
                                    class="mb-6 bg-green-500/20 border border-green-500/30 text-green-100 px-4 py-3 rounded-lg">
                            ...
                            <form action="{{ route('client.quote-request.store') }}" method="POST" class="space-y-6">
                                ...
                                <div>
                                    <label for="device_type" class="block text-sm font-medium text-blue-100 mb-2">Device
                                        Type *</label>
                                    <select id="device_type" name="device_type" required
                                        ...
                                        @foreach ($deviceTypes as $deviceType)
                                            <option value="{{ $deviceType->device_type_name }}" class="bg-gray-800"
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                categoryFilters.forEach(filter => {
                    filter.addEventListener('click', function(event) {
                        ...
                        // Lọc service
                        serviceCategories.forEach(serviceCategory => {
                            if (category === 'all' || serviceCategory.classList.contains(
                                    slugify(category))) {
                                serviceCategory.style.display = 'block';
                            } else {
                                serviceCategory.style.display = 'none';
