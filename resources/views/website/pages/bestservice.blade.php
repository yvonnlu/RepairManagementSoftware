    ...
    <div class="container mx-auto px-6">
        ...
        <div class="space-y-12">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                ...
                <div
                    class="service-category {{ Str::slug($service->device_type_name) }} bg-gradient-to-r from-blue-500 to-blue-600 p-8 text-white">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h2 class="text-2xl md:text-3xl font-bold">{{ $service->device_type_name }}</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden p-6 flex flex-col">
                <div class="flex items-center space-x-4 mb-4">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-gray-900">{{ $service->device_type_name }}</h2>
                    </div>
                </div>
                ...
                <a href="" class="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors flex items-center justify-center space-x-2 mt-auto">
                    <i data-lucide="calendar" class="w-4 h-4"></i>
                    <span>Book Now</span>
                </a>
            </div>
