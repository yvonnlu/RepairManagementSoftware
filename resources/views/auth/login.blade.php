        ...
        <div class="relative w-full max-w-md">
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-purple-100 p-8 space-y-6">
                ...
                <div class="text-center space-y-3">
                    ...
                    <p class="text-gray-600 font-medium">Sign in to your Fixicon account</p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input id="email" name="email" type="email" autocomplete="username" required autofocus
                                value="{{ old('email') }}"
                                class="block w-full pl-12 pr-4 py-3 border-2 rounded-xl shadow-sm placeholder-gray-400 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-purple-500/20 {{ $errors->get('email') ? 'border-red-300 focus:border-red-500' : 'border-gray-200 focus:border-purple-500 hover:border-purple-300' }}"
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input id="password" name="password" type="password" autocomplete="current-password" required
                                class="block w-full pl-12 pr-12 py-3 border-2 rounded-xl shadow-sm placeholder-gray-400 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-purple-500/20 {{ $errors->get('password') ? 'border-red-300 focus:border-red-500' : 'border-gray-200 focus:border-purple-500 hover:border-purple-300' }}"
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center cursor-pointer group">
                            ...
                            <span
                                class="ml-3 text-sm font-medium text-gray-700 group-hover:text-purple-600 transition-colors">
                                Remember me
                            </span>
                        </label>
                        ...
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}"
                                class="text-sm font-semibold text-purple-600 hover:text-purple-800 transition-colors hover:underline">
                                Forgot password?
                            </a>
                        @endif
                    </div>
                    ...
                    {{-- Login Button --}}
                    <button type="submit"
                        class="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-xl shadow-lg text-sm font-semibold text-white bg-gradient-to-r from-purple-600 to-violet-600 hover:from-purple-700 hover:to-violet-700 focus:outline-none focus:ring-4 focus:ring-purple-500/50 transform transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]">
                        Sign in
                    </button>
                ...
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-4 mt-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h4 class="text-sm font-semibold text-blue-900 mb-1">Account locked or deactivated?</h4>
                            <p class="text-xs text-blue-700 mb-2">If you're unable to access your account, our support team
                                can help reactivate it.</p>
                            <div class="space-y-1">
